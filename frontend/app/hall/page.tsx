...
const images = [
  { src: '/images/hall/1.png', alt: 'Slide 1' },
  { src: '/images/hall/2.png', alt: 'Slide 2' },
  { src: '/images/hall/3.png', alt: 'Slide 3' },
  { src: '/images/hall/4.png', alt: 'Slide 4' },
  { src: '/images/hall/5.png', alt: 'Slide 5' },
];
